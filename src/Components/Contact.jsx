...
export default function Contact() {
    ...
    <div class="container flex flex-col min-h-screen px-6 py-12 mx-auto">
        <div class="flex-1 lg:flex lg:items-center lg:-mx-6">
            <div class="text-white lg:w-1/2 lg:mx-6">
                <h1 class="text-2xl font-semibold capitalize lg:text-3xl"></h1>
                ...
                <div class="mt-6 space-y-8 md:mt-8">
                    <p class="flex items-start -mx-2">
                        ...
                        <span class="mx-2 text-white truncate w-72">
                            vethavarshini 711-2880 Nulla St. Madurai Mississippi 625008
                        </span>
                    </p>
                    ...
                    <p class="flex items-start -mx-2">
                        ...
                        <span class="mx-2 text-white truncate w-72">91 + 9788039505</span>
                    </p>
                    ...
                    <p class="flex items-start -mx-2">
                        ...
                        <span class="mx-2 text-white truncate w-72">vetha@example.com</span>
                    </p>
                </div>
  ...
  <button 
    type="submit" 
    class="w-full px-6 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-gradient-to-r from-green-400 to-blue-500 rounded-md hover:bg-gradient-to-r hover:from-green-500 hover:to-blue-600 focus:outline-none focus:ring focus:ring-blue-400 focus:ring-opacity-50"
  >
    Get in touch
  </button>
</form>
